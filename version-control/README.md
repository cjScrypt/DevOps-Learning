...
![Create new project panel](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/create-project.png)
...
1. On your lab computer, in a browser window open your Azure DevOps organization and the previously created eShopOnWeb project. Click on Repos>Files , Import. On the Import a Git Repository window, paste the following URL
> `https://github.com/MicrosoftLearning/eShopOnWeb.git`

and click on **Import**:

![Import repository panel](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/import-repo.png)
...
![Clone Git repository](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/clone-repo.png)
...
![vscode command palette](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/vscode-command.png)
...
10. Within the Select Folder dialog box, navigate to the C: drive, create a new folder named Git, select it, and then click Select as Repository Destination.
...
![source control tab](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/first-commit.png)
...
![commit history](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/ado-commit.png)
...
![](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/staged-changes.png)
...
![non staged file version](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/file-comparison.png)
...
![browse files](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/commit-browse.png)
...
![create new branch](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/create-branch.png)


4. In the **Select a ref to create the branch from** textbox, select main as the reference branch.
...
![delete branch](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/delete-branch.png)
...
8. Go to the web browser displaying the Mine tab of the Branches

9. On the Mine tab of the Branches pane, select the All tab.

10. On the All tab of the Branches pane, in the Search branch name text box, type dev.

11. Review the Deleted branches section containing the entry representing the newly deleted branch.

12. In the Deleted branches section, hover the mouse pointer over the dev branch entry to reveal the ellipsis symbol on the right side.

13. Click the ellipsis, in the pop-up menu and select Restore branch.
![restore branch](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/restore-branch.png)
...
![check linked work](https://microsoftlearning.github.io/AZ400-DesigningandImplementingMicrosoftDevOpsSolutions/Instructions/Labs/images/policy-settings.png)
